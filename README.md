...
| [公众号转英文 X Article](skills/wechat-to-x-article/SKILL.md) | 提取微信公众号正文，改写为地道英文 X Article，并生成可保留标题、粗体、链接和引用格式的富文本复制页 |
...
cp -R self-media-skills/skills/wechat-to-x-article ~/.codex/skills/
```
